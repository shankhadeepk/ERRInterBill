...
CREATE TABLE IBP_ORDERLINE_PCRF
(
...
CREATE UNIQUE INDEX IBP_ORDERLINE_PCRF_PK ON IBP_ORDERLINE_PCRF
(REQUEST_ID)
LOGGING
TABLESPACE DATA
PCTFREE    10
...
ALTER TABLE IBP_ORDERLINE_PCRF ADD (
  CONSTRAINT IBP_ORDERLINE_PCRF_PK
 PRIMARY KEY
 (REQUEST_ID)
    USING INDEX 
    TABLESPACE DATA
