...
CREATE UNIQUE INDEX IBP_ORDERLINE_MZ_PK ON IBP_ORDERLINE_MZ
(REQUEST_ID)
LOGGING
TABLESPACE DATA
PCTFREE    10
...
ALTER TABLE IBP_ORDERLINE_MZ ADD (
  CONSTRAINT IBP_ORDERLINE_MZ_PK
 PRIMARY KEY
 (REQUEST_ID)
    USING INDEX 
    TABLESPACE DATA
