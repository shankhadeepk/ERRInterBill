...
public class ActivationSumNShare extends UpdateLinkTableAbst{

	@Override
	public IBPProdConsLinkCollection updateLink(IBPInputBean input) {
		// TODO Auto-generated method stub
			//first call newLinksForFullShared()
		input.getModifiedProdConsLinks().getNewLinksForInsert().addAll(this.newLinksForSumNShare());
	...
	private List<IBPProdConsLinkInsert> newLinksForSumNShare()
	{
		return null;
	}
