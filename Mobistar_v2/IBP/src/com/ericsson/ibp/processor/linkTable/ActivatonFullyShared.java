...
public class ActivatonFullyShared extends UpdateLinkTableAbst{

	@Override
	public IBPProdConsLinkCollection updateLink(IBPInputBean input) {
		// TODO Auto-generated method stub
			//first call newLinksForFullShared()
		input.getModifiedProdConsLinks().getNewLinksForInsert().addAll(this.newLinksForFullShared());
	...
	private List<IBPProdConsLinkInsert> newLinksForFullShared()
	{
		return null;
	}
