...
public class ActivationPartiallySharedExplicit extends UpdateLinkTableAbst{

	@Override
	public IBPProdConsLinkCollection updateLink(IBPInputBean input) {
		// TODO Auto-generated method stub
			//first call newLinksForFullShared()
		input.getModifiedProdConsLinks().getNewLinksForInsert().addAll(this.newLinksForPartiallySharedExplicit());
	...
	private List<IBPProdConsLinkInsert> newLinksForPartiallySharedExplicit()
	{
		return null;
	}
